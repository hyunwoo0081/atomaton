...
- **No Wildcard Types**: Never use 'any' in TypeScript. Prefer explicit interface definitions or Prisma-generated types (`@atomaton/db`).
...
_Note: This constitution is self-improving. If you encounter an environmental issue or a recurring bug pattern, propose an amendment to this file to prevent future AI instances from making the same mistake._
