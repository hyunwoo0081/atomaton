    ...
    <div className="h-screen w-full flex flex-col">
      ...
      <header className="h-14 border-b flex items-center px-4 justify-between bg-white z-10">
        ...
        <div className="space-x-2">
          <button className="px-3 py-1 bg-gray-100 rounded hover:bg-gray-200 text-sm" onClick={() => console.log({ nodes, edges })}>
            Save
          </button>
        ...
        {selectedNode && (
          <aside className="w-80 border-l bg-white p-4 overflow-y-auto z-10 shadow-xl flex flex-col">
            <div className="flex justify-between items-center mb-4 border-b pb-2">
              ...
              <button onClick={() => setSelectedNodeId(null)} className="text-gray-500 hover:text-gray-700">✕</button>
            </div>
                ...
                <div>
                  ...
                  {selectedNode.data.type === 'imap' && (
                    <div className="mt-2 space-y-2 p-2 bg-gray-50 rounded">
                      <p className="text-xs font-bold text-gray-500">IMAP Settings</p>
                      <input 
                        type="text" 
                        placeholder="Host" 
                      ...
                      <input 
                        ...
                        onChange={(e) => updateNodeData(selectedNode.id, { user: e.target.value })}
                      />
                      <input 
                        type="password" 
                        ...
                        onChange={(e) => updateNodeData(selectedNode.id, { password: e.target.value })}
                      />
                    </div>
                  )}
                  ...
                  {selectedNode.data.type === 'webhook' && (
                    <div className="mt-2 space-y-2 p-2 bg-gray-50 rounded">
                      <p className="text-xs font-bold text-gray-500">Webhook URL</p>
                  ...
                  {selectedNode.data.service === 'notion' && (
                    <div className="mt-2 space-y-2">
                      ...
                      <input 
                        ...
                        onChange={(e) => updateNodeData(selectedNode.id, { databaseId: e.target.value })}
                      />
                    </div>
                  )}
                </div>
