        ...
        <div className="p-6 flex-1 overflow-y-auto">
          ...
          {result && (
            <div className="mb-4 animate-fade-in">
              ...
              <div
                className={`p-4 rounded-xl border text-sm font-mono whitespace-pre-wrap overflow-auto max-h-60 ${result.error ? 'bg-[#FF2E63]/10 border-[#FF2E63]/30 text-[#FF2E63]' : 'bg-[#00F5A0]/10 border-[#00F5A0]/30 text-[#00F5A0]'}`}
              >
